...
<SectionHeader title="Response Schema" size="small" subtitle="B2CAccountTopUpResponse — the synchronous acknowledgement returned by client.b2c.account_topup(...)" />
...
<SectionHeader title="Result Callback Schema" size="small" subtitle="B2CAccountTopUpCallback — posted to ResultURL once the top-up completes" />
...
parameters={[
    {
        ...
        dataType: "Integer",
        required: true,
        description: "Status code for the transaction sent to the listener."
    },
    {
    ...
    },
    {
        ...
        dataType: "String",
        required: true,
        description: "Unique request identifier assigned by the API gateway."
    },
    {
...
<SectionHeader title="Timeout Callback Schema" size="small" subtitle="B2CAccountTopUpTimeoutCallback — posted to QueueTimeOutURL if the top-up doesn't complete in time" />
...
parameters={[
    {
        ...
        dataType: "Integer",
        required: true,
        description: "1 indicates a timeout."
    },
    {
        name: "Result.ResultCode",
        type: "str",
    ...
    },
    {
        ...
        dataType: "String",
        required: true,
        description: "Description of the timeout event, e.g. 'The service request timed out.'"
    },
    {
        name: "Result.OriginatorConversationID",
        type: "str",
...
parameters={[
    {
        ...
        dataType: "Integer/String",
        required: false,
        description: "Defaults to 0. Used by B2CAccountTopUpCallbackResponse and B2CAccountTopUpTimeoutCallbackResponse — the typed models to return from your /result and /timeout handlers respectively."
    },
    {
        name: "ResultDesc",
        type: "str",
        dataType: "String",
        required: false,
        description: "Defaults to 'Callback processed successfully' (result) or 'Timeout notification received and processed successfully.' (timeout)."
    }
]}
/>
