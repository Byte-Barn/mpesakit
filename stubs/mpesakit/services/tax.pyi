...
class AsyncTaxService:
    ...
    async def remittance(self, initiator: str, security_credential: str, amount: int, party_a: int, remarks: str, account_reference: str, result_url: str, queue_timeout_url: str, **kwargs) -> TaxRemittanceResponse: ...
