...
class AsyncReversalService:
    ...
    async def reverse(self, initiator: str, security_credential: str, transaction_id: str, amount: int, receiver_party: int, result_url: str, queue_timeout_url: str, remarks: str, occasion: str | None = None, **kwargs) -> ReversalResponse: ...
