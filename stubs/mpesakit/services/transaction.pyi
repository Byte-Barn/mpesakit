...
class AsyncTransactionService:
    ...
    async def query_status(self, initiator: str, security_credential: str, transaction_id: str, party_a: int, identifier_type: int, result_url: str, queue_timeout_url: str, occasion: str = '', command_id: str | None = None, remarks: str | None = None, original_conversation_id: str | None = None, **kwargs) -> TransactionStatusResponse: ...
