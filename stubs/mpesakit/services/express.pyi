...
class AsyncStkPushService:
    ...
    async def push(self, business_short_code: int, transaction_type: str, amount: float, party_a: str, party_b: str, phone_number: str, callback_url: str, account_reference: str, transaction_desc: str, passkey: str | None = None, timestamp: str | None = None, password: str | None = None, **kwargs) -> StkPushSimulateResponse: ...
    async def query(self, business_short_code: int, checkout_request_id: str, passkey: str | None = None, password: str | None = None, timestamp: str | None = None, **kwargs) -> StkPushQueryResponse: ...
