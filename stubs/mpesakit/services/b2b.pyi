...
class AsyncB2BService:
    ...
    async def express_checkout(self, primary_short_code: str, receiver_short_code: str, amount: int, payment_ref: str, callback_url: str, partner_name: str, request_ref_id: str, **kwargs) -> B2BExpressCheckoutResponse: ...
    async def paybill(self, initiator: str, security_credential: str, amount: int, party_a: int, party_b: int, account_reference: str, requester: str, remarks: str, queue_timeout_url: str, result_url: str, **kwargs) -> BusinessPayBillResponse: ...
    async def buygoods(self, initiator: str, security_credential: str, amount: int, party_a: int, party_b: int, account_reference: str, requester: str, remarks: str, queue_timeout_url: str, result_url: str, occassion: str | None = None, **kwargs) -> BusinessBuyGoodsResponse: ...
